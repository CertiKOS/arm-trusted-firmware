...
CFLAGS += -DCERTIKOS_REGION_SIZE=${CERTIKOS_REGION_SIZE}
CFLAGS += -DTHINROS_PARTITION_ADDR=${THINROS_PARTITION_ADDR}
CFLAGS += -DTHINROS_PARTITION_SIZE=${THINROS_PARTITION_SIZE}
